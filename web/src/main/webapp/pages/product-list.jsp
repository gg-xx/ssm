                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="${pageContext.request.contextPath}/product/deleteProduct.do?id=${product.id}" class="btn bg-olive btn-xs">删除</a>
                                    ...
                                    <a href="${pageContext.request.contextPath}/product/mid.do?id=${product.id}" class="btn bg-olive btn-xs">编辑</a>
                                </td>
                            </tr>
                            </c:forEach>
